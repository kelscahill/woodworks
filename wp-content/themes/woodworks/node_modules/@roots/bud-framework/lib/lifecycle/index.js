...
import { DEVELOPMENT_SERVICES, LIFECYCLE_EVENTS, PARENT_SERVICES, } from './constants.js';
/**
 ...
 * @public
 */
export async function lifecycle(options) {
    this.children = {};
    ...
    this.services = Object.entries({ ...options.services })
        .filter(([name]) => this.isDevelopment || !DEVELOPMENT_SERVICES.includes(name))
    ...
    await LIFECYCLE_EVENTS.reduce(async (promised, event) => {
        await promised;
        await Promise.all(Object.keys(this.services)
