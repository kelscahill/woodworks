...
export interface Rule extends Base {
     ...
     * @public
     */
    setUse<K extends keyof Items & string>(use: ((use: Array<K>, app: Bud) => Array<K>) | Array<K>): this;
    /**
     * Use item
     *
     * @public
     ...
     * @public
     */
    setExclude(excludes: ((excludes: Array<string | RegExp | ((app: Bud) => string | RegExp)>) => Array<string | RegExp | ((app: Bud) => string | RegExp)>) | Array<string | RegExp | ((app: Bud) => string | RegExp)>): this;
    /**
     * Include paths
     *
     * @public
     ...
     * @public
     */
    setInclude(value: ((includes: Rule['include']) => Rule['include']) | Rule['include']): this;
    /**
     * Type
     *
     * @public
     ...
     * @public
     */
    setGenerator(Generator: ((app: Bud) => Rule['generator']) | Rule['generator']): this;
    /**
