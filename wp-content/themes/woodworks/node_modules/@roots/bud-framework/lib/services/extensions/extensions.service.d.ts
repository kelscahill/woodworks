...
export interface Service extends BaseService {
     ...
     * @public
     */
    add(input: Constructor | ExtensionLiteral | Array<Constructor | ExtensionLiteral>): Promise<void>;
    ...
    runAll(methodName: '_init' | '_register' | '_boot' | '_afterConfig' | '_beforeBuild' | '_make'): Promise<Array<void>>;
    ...
    runDependencies<K extends Modules>(extension: Modules[K & string], methodName: '_init' | '_register' | '_boot' | '_afterConfig' | '_beforeBuild' | '_make'): Promise<void>;
    /**
