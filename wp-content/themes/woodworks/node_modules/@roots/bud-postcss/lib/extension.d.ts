...
declare type InputList = Array<string | [string, any?]>;
declare type InputRecords = Record<string, Input>;
declare type InputMap = Map<string, Input>;
declare type Registry = Map<string, [string | Plugin | Processor, any?]>;
/**
...
export default class BudPostCss extends Extension {
    ...
    protected get postcssOptions(): {
        plugins: () => [string | Plugin | Processor, any?][];
        syntax?: string;
    };
    /**
     ...
     *
     */
    postcssPluginsHooksCallback(): any[];
    /**
