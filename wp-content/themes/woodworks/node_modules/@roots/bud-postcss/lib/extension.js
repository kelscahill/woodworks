...
import { bind, expose, label, once, } from '@roots/bud-framework/extension/decorators';
...
let BudPostCss = class BudPostCss extends Extension {
     ...
     */
    get postcssOptions() {
        const plugins = this.app.hooks.filter('postcss.plugins', this.postcssPluginsHooksCallback);
        return {
...
__decorate([
    bind
], BudPostCss.prototype, "postcssPluginsHooksCallback", null);
__decorate([
    bind
