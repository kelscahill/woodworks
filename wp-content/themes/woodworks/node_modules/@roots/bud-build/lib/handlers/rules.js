 ...
 * @public
 */
export const js = async (app) => app.build
    .makeRule()
 ...
 * @public
 */
export const image = async (app) => app.build
    .makeRule()
 ...
 * @public
 */
export const webp = async (app) => app.build
    .makeRule()
 ...
 * @public
 */
export const svg = async (app) => app.build
    .makeRule()
 ...
 * @public
 */
export const font = async (app) => app.build
    .makeRule()
    .setType('asset')
 ...
 * @public
 */
export const json = async (app) => app.build
    .makeRule()
    .setType('json')
 ...
 * @public
 */
export const yml = async (app) => app.build
    .makeRule()
    .setInclude([app => app.path()])
    .setExclude([app => app.path('@modules')])
 ...
 * @public
 */
export const html = async (app) => app.build
    .makeRule()
    .setInclude([app => app.path()])
    .setExclude([app => app.path('@modules')])
 ...
 * @public
 */
export const csv = async (app) => app.build
    .makeRule()
    .setInclude([app => app.path()])
    .setExclude([app => app.path('@modules')])
 ...
 * @public
 */
export const xml = async (app) => app.build
    .makeRule()
    .setInclude([app => app.path()])
    .setExclude([app => app.path('@modules')])
 ...
 * @public
 */
export const toml = async (app) => app.build
    .makeRule()
    .setType('json')
    .setInclude([app => app.path()])
    .setExclude([app => app.path('@modules')])
