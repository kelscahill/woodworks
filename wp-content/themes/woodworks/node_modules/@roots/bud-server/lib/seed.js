...
export const seed = (app) => {
    app.hooks
        ...
        .hooks.on(`dev.middleware.dev.options.publicPath`, () => app.hooks.filter('build.output.publicPath'))
        ...
        .hooks.on(`dev.middleware.hot.options.log`, app.logger.instance.scope('hot').info)
