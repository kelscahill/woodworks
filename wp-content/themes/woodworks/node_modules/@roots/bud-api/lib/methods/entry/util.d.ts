...
export declare type EntryObject = Config.Entry.EntryObject;
export declare type Input = [string] | [Array<string>] | [string, string | Array<string>] | [Record<string, string | Array<string>>] | [Record<string, Config.Entry.EntryObject>];
